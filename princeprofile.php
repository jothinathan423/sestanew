...
if ($prince_id !== null) {
    ...
    $stmt->bind_param("i", $prince_id); // Assuming mentor_id is an integer, use "i" for integers
    $stmt->execute();
...
$query_data = "SELECT * FROM principal where principal_id = $principal_id"; // Update query as per your database schema
