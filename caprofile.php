...
if ($ca_id !== null) {
    $query = "SELECT * FROM ca WHERE ca_id = ?";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("i", $ca_id); // Assuming mentor_id is an integer, use "i" for integers
    $stmt->execute();
...
$query_data = "SELECT * FROM ca where ca_id = $ca_id"; // Update query as per your database schema
