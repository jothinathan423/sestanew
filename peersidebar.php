...
if (!isset($_SESSION['peer_id'])) {
  header("Location: peer_login.html");
    exit();
}
...
$query = "SELECT images FROM peer_mentor WHERE peer_id = $peer_id"; // Adjust table and column names
...
$query = "SELECT name FROM peer_mentor WHERE peer_id = $peer_id"; // Replace 'name' and 'ca_id' with your actual column and identifier names
...
?>
                  ...
                  <p class="designation">Student Peer Mentor</p>
                </div>
            ...
            <li class="nav-item">
              <a class="nav-link" href="peer_chart.php">
                <span class="menu-title">Charts</span>
                <i class="icon-chart menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="peer_dashboard.php#students">
                <span class="menu-title">Tables</span>
                <i class="icon-grid menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="peer_download.php">
