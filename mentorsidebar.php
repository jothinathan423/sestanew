...
$query = "SELECT images FROM mentors WHERE mentor_id = $ment_id"; // Adjust table and column names
...
$query = "SELECT mentor_name FROM mentors WHERE mentor_id = $mentor_id"; // Replace 'name' and 'ca_id' with your actual column and identifier names

$result = $conn->query($query);

if ($result && $result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $ment_name = $row['mentor_name'];
    echo "$ment_name";
} else {
    echo "ment not found.";
}
...
?></p>
            ...
            <li class="nav-item">
              <a class="nav-link" href="mentorprofile.php?<?php echo "mentor_id=" . $_SESSION['mentor_id']; ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" href="ment_chart.php">
                <span class="menu-title">Charts</span>
                <i class="icon-chart menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="mentor_dashboard.php#students">
                <span class="menu-title">Tables</span>
                <i class="icon-grid menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="mentor_download.php">
