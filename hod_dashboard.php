...
$sql = "SELECT COUNT(*) AS student_count FROM students WHERE branch = '$branch";
                    ...
                    <div class="row report-inner-cards-wrapper">
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          <br>
                          <?php
        $zeroCreditQuery = "SELECT COUNT(*) AS zero_credit_count FROM students WHERE credit_points = 0 and branch ='$branch'";
        ...
        ?>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          ...
                          <?php
$above100CreditQuery = "SELECT COUNT(*) AS above_100_credit_count FROM students WHERE credit_points > 100 and branch='$branch'";
    ...
    <option value="4">Year 4</option>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='hod_student_activities.php?id=" . $row['id'] . "' class='btn btn-info'>Details</a></td>";
                echo "</tr>";
            }
...
function filterTable() {
    ...
    for (var i = 1; i < rows.length; i++) { // Start from 1 to skip header row
        ...
        var year = cells[2].innerHTML; // Assuming the year is in the third column
         // Assuming the branch is in the fourth column
