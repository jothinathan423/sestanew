...
if ($mentor_id !== null) {
    ...
    $stmt->bind_param("i", $mentor_id); // Assuming mentor_id is an integer, use "i" for integers
    $stmt->execute();
...
$query_data = "SELECT * FROM mentors where mentor_id = $mentor_id"; // Update query as per your database schema
...
if ($result_data->num_rows > 0) {
    while ($row = $result_data->fetch_assoc()) {
        ...
        echo "<div class='row'>
            <div class='col-md-6'><h5 class='card-text'>Department</h5></div>
