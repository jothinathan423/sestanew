...
$hod_id = $_SESSION['principal_id'];

// Query to retrieve the image link associated with the CA's session ID
$query = "SELECT images FROM principal WHERE principal_id = $hod_id"; // Adjust table and column names
...
$query = "SELECT name FROM principal WHERE principal_id = $principal_id"; // Replace 'name' and 'ca_id' with your actual column and identifier names
...
?></p>
            ...
            <li class="nav-item">
              <a class="nav-link" href="princeprofile.php?<?php echo "principal_id=" . $_SESSION['principal_id']; ?>">
            ...
            <li class="nav-item">
              <a class="nav-link" href="prince_chart.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="principaldash.php">
                <span class="menu-title">Home</span>
                <i class="icon-grid menu-icon"></i>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="principal_dashboard.php#students">
